...
$(MONOLITHIC_DIR)/README: README $(MONOLITHIC_MKDIRSTAMP)
	cp $< $@
...
$(MONOLITHIC_PACKAGE_FILE_WITH_SAMPLE): $(MONOLITHIC_PACKAGE_FILE) $(SRCDIR)/sample $(VERSION_FILE) $(MONOLITHIC_PACKAGE_MKDIRSTAMP)
	cat $(MONOLITHIC_PACKAGE_FILE) $(SRCDIR)/sample > $@
$(MONOLITHIC_PACKAGE_DIR)/README: README $(MONOLITHIC_PACKAGE_MKDIRSTAMP)
	cp $< $@
